...
class Nunil_Captured_Tags {
	...
	public static function get_captured_tags() {
		...
		if ( 1 === $options['script-src_enabled'] ) {
			...
			$inline       = true;
			$tags[]       = new Nunil_HTML_Tag( $directive, $tag, $stored_attr, $needed_attrs, $childs = null, $inline );
		...
		if ( 1 === $options['style-src_enabled'] ) {
			...
			$tag    = 'style';
			$inline = true;
			$tags[] = new Nunil_HTML_Tag( $directive, $tag, $stored_attr = null, $needed_attrs = null, $childs = null, $inline );
		}
		...
		if ( 1 === $options['img-src_enabled'] ) {
			...
			$tag         = 'img';
			$stored_attr = 'src';
			$tags[]      = new Nunil_HTML_Tag( $directive, $tag, $stored_attr, $needed_attrs = null, $childs = null, $inline );
			...
			$tags[]      = new Nunil_HTML_Tag( $directive, $tag, $stored_attr, $needed_attrs = null, $childs, $inline );
