...
class Nunil_Clustering {
	 ...
	 * @return array<array<array<string>>> Array of cluster made of arrays
	 */
	 ...
	 * @param array<array<array<string>>> $dbscan_results An array of clustered arrays returned by make_db_scan().
	 *
