...
class No_Unsafe_Inline_Public {
	...
	public function enqueue_scripts(): void {
		...
		( 1 === $options['fix_setattribute_style'] )
			...
			wp_enqueue_script( $this->plugin_name . '_jquery-htmlprefilter-override', plugin_dir_url( NO_UNSAFE_INLINE_PLUGIN_BASENAME ) . 'includes/js/no-unsafe-inline-prefilter-override.js', array( 'jquery' ), $this->version, false );
			wp_enqueue_script( $this->plugin_name . '_fix_setattribute_style', plugin_dir_url( NO_UNSAFE_INLINE_PLUGIN_BASENAME ) . 'includes/js/no-unsafe-inline-fix-style.js', array(), $this->version, false );
		}
	}
