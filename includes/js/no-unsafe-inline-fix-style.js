...
Element.prototype.setAttribute = function (attr, val) {
	if (attr.toLowerCase() !== 'style') {
		 ...
		 * The problem is to correct split somthing as:
		 ...
		 */
		let re1 = new MyRegExp( /(?<!\&quot);(?!base64)/gm ); // TODO: All semicolon not surrended by &quot; Not it is all semicolon not followed by base64 and not preceded by &quot
		let re2 = new MyRegExp( /(?<!data):/gm ); // All colon not preceded by data
